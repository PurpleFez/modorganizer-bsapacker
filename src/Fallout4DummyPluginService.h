...
namespace BsaPacker
{
	...
	{
	public:
		Fallout4DummyPluginService(const IFileWriterService* fileWriterService, const IDummyPluginLogic* dummyPluginLogic);
		...
		static constexpr int RAW_FO4_SIZE = 49;
		static constexpr unsigned char RAW_FALLOUT4[RAW_FO4_SIZE] = {
