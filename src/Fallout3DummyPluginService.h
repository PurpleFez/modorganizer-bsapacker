...
namespace BsaPacker
{
	class Fallout3DummyPluginService : public IDummyPluginService
	{
	public:
		Fallout3DummyPluginService(const IFileWriterService* fileWriterService, const IDummyPluginLogic* dummyPluginLogic);
		...
		static constexpr int RAW_FO3_SIZE = 49;
		static constexpr unsigned char RAW_FALLOUT3[RAW_FO3_SIZE] = {
